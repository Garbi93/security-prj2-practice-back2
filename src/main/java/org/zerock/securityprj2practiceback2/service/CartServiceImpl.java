...
import org.zerock.securityprj2practiceback2.repository.CartItemRepository;
import org.zerock.securityprj2practiceback2.repository.CartRepository;
...
public class CartServiceImpl implements CartService {
    ...
    private Cart getCart(String email) {
        ...
        if (result.isEmpty()) {
            ...
            // 장바구니가 없으면 Cart 객체 생성하고 추가 반환
            log.info("Cart of the number is not exist!!");
            ...
            // 해당 email 의 장바구니 (Cart) 가 있는지 확인 있으면 반환
            cart = result.get();
